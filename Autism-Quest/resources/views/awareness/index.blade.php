...
@section('content')
    <div class="container-fluid">
        <section class="row my-0 vh-100 bg-info text-white mb-0" id="section1">
            <div class="col-md-7 h-100">
                <img src="{{ asset('images/awareness1.jpg') }}" class="img-fluid rounded" alt="Image">
            </div>
            <div class="col-md-5">
                ...
                <div class="doodle-container" id="sun" style="z-index: 2;">
                    <img src="{{ asset('images/doodle2.png') }}" class="img-fluid" alt="Doodle">
                </div>
            </div>
        </section>
        <section class="row my-0 vh-100 text-dark mb-0" id="section2">
            <div class="col-md-5 h-100">
                ...
                <!-- Doodle image container -->
                <div class="doodle-container" id="hearts">
                    <img src="{{ asset('images/doodle1.png') }}" class="img-fluid" alt="Doodle">
                </div>
            </div>
            <div class="col-md-7">
                <img src="{{ asset('images/awareness3.jpg') }}" class="img-fluid rounded" alt="Image">
            </div>
        </section>
        <section class="row my-0 vh-100 text-white mb-0" id="section3">
            <div class="col-md-7 h-100">
                <img src="{{ asset('images/awareness2.jpg') }}" class="img-fluid rounded" alt="Image">
            </div>
            <div class="col-md-5">
